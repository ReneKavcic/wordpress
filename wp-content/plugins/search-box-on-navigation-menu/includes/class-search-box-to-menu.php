...
class Search_On_Menu {
	...
	private function define_admin_hooks() {
		...
		if ( ! isset( $options['dismiss_admin_notices'] ) || ! $options['dismiss_admin_notices'] ) {
			$this->loader->add_action( 'all_admin_notices', $admin, 'search_box_to_menu_setup_notice' );
		}
		...
		$this->loader->add_action( 'wp_ajax_nopriv_search_box_to_menu_notice_dismiss', $admin, 'search_box_to_menu_notice_dismiss' );
		$this->loader->add_action( 'wp_ajax_search_box_to_menu_notice_dismiss', $admin, 'search_box_to_menu_notice_dismiss' );
		$this->loader->add_action( 'admin_enqueue_scripts', $admin, 'search_box_to_menu_load_admin_assets' );
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'wp_enqueue_scripts', $public, 'search_box_to_menu_script_style' );
